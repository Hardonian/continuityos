import pytest
from continuityos.crypto import ZKPProver, ZKPReserveCommitment, ZKPReserveProof
...
def test_zkp_reserve_proof_valid() -> None:
    ...
    commitment = prover.generate_commitment(entity_id="nato-logistics-1", commodity_id="F-76-Diesel")
